...
const _HELP_DOCS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Gérer les licences logicielles", a: "Parc IT → Licences → + Nouvelle licence. Renseignez : nom du produit, nombre de licences (quantité), licences assignées, coût par unité et département. NexHire calcule le taux d'utilisation et génère un risque si ce taux est inférieur à 20 % — signalant des licences inutilisées à récupérer." },
      { q: "Taux d'utilisation des licences et recommandations", a: "NexHire analyse chaque licence : si moins de 20 % des licences sont assignées, une recommandation apparaît dans l'onglet Analytique → Top opportunités. Le calcul des économies = licences non assignées × coût unitaire. Exemple : 8 licences inutilisées à 25 $/unité = 200 $/mois récupérables." },
    ],
  },
  {

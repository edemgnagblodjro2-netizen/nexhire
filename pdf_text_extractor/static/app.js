...
const T = {
  fr: {
    ...
    'land.stats.tag':"Cette plateforme ne fait pas que répondre à des questions. <strong>Elle trouve de l'argent.</strong>",
  ...
  en: {
    ...
    'land.stats.tag':"This platform doesn't just answer questions. <strong>It finds money.</strong>",
  ...
  es: {
    ...
    'land.stats.tag':"Esta plataforma no solo responde preguntas. <strong>Encuentra dinero.</strong>",

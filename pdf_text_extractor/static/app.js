...
const T = {
  fr: {
    ...
    'audit.click.hint':'Cliquez sur une ligne pour voir les détails complets.',
    'org.title':'Intelligence d\'Entreprise','org.refresh':'↻ Actualiser',
    'org.tab.dashboard':'🏛️ Tableau de bord','org.tab.copilot':'🤖 Executive Copilot',
    'org.dept.health':'Santé des départements',
    'org.legend.healthy':'Sain','org.legend.warning':'Attention','org.legend.risk':'À risque',
    'org.loading':'Chargement…',
    'security.title':'Tableau de bord Sécurité',
    'security.score.label':'Score de sécurité',
    'security.score.loading':'Chargement…',
    'security.kpi.mfa':'MFA activé',
    'security.kpi.alerts':'Alertes non traitées',
    'security.kpi.compliance':'Conformité Loi 25',
    'security.alerts.title':'Alertes de sécurité',
    'security.alerts.refresh':'Actualiser',
    'security.login.title':'Connexions — 7 derniers jours',
    'security.ip.title':'IPs de connexion récentes',
    'security.mfa.title':'Gestion MFA',
    'security.mfa.require':'Exiger MFA organisation',
    'security.mfa.desc':'Les utilisateurs peuvent activer leur MFA dans <strong>Paramètres → Sécurité</strong>. Vous pouvez exiger le MFA pour tous les membres de l\'organisation.',
    'team.tab.executive':'🎯 Vue Exécutive','team.tab.effectifs':'👥 Effectifs',
    'team.tab.departements':'🏢 Départements','team.tab.structure':'📊 Structure',
    'team.tab.prestataires':'🤝 Prestataires',
    'team.structure.title':'📊 Organigramme','team.structure.refresh':'↻ Actualiser',
    'team.contractors.title':'🤝 Collaborateurs externes','team.contractors.add':'+ Ajouter',
    'team.contractors.desc':'Consultants, prestataires, fournisseurs et sous-traitants liés à votre organisation ou à des départements spécifiques.',
    'team.role.requests':'⏳ Demandes d\'élévation de rôle',
    'billing.title':'Facturation & abonnement',
    'billing.subtitle':'Gérez votre plan NexHire EIP',
    'billing.refresh':'↺ Actualiser',
    'billing.eyebrow':'Tarifs simples · Commencez gratuitement · Payez quand vous êtes prêt',
    'billing.trial.pill':'14 jours d\'essai complet inclus · Accès à tous les connecteurs · Aucune carte requise',
    'billing.plan.starter.target':'PME · Cabinets · 10–50 employés',
    'billing.plan.professional.target':'PME · Municipalités · 50–500 employés',
    'billing.plan.enterprise.target':'Hôpitaux · Universités · Grandes entreprises',
    'billing.plan.featured':'Plan principal',
    'billing.plan.enterprise.note':'Sur devis · Contrat annuel',
    'billing.btn.trial':'Commencer l\'essai gratuit',
    'billing.btn.trial.sub':'14 jours gratuits · Sans engagement',
    'billing.btn.contact':'Nous contacter →',
    'billing.btn.contact.sub':'Déploiement accompagné · SLA garanti',
    'billing.quota.title':'Utilisation ce mois',
    'billing.quota.loading':'Chargement…',
    'billing.portal.btn':'Gérer l\'abonnement via Stripe →',
    'billing.portal.desc':'Modifiez votre plan, téléchargez les factures, mettez à jour le moyen de paiement.',
    'help.hero.badge':'Centre d\'aide',
    'help.hero.title':'Comment pouvons-nous vous aider ?',
    'help.hero.sub':'Documentation, guides et support technique pour NexHire EIP',
    'help.topics.connectors.title':'Connecteurs',
    'help.topics.connectors.desc':'M365, Jira, SAP, Salesforce…',
    'help.topics.team.title':'Organisation & équipe',
    'help.topics.team.desc':'Membres, rôles, départements',
    'help.topics.security.title':'Sécurité & conformité',
    'help.topics.security.desc':'RLS, MFA, audit, RGPD',
    'help.topics.billing.title':'Facturation',
    'help.topics.billing.desc':'Plans, abonnement, quotas',
    'help.faq.title':'Questions fréquentes',
    'help.contact.title':'Contacter le support',
    'help.contact.sub':'Réponse sous <strong>24 h</strong> ouvrables · Équipe bilingue FR / EN',
    'help.form.category':'Catégorie',
    'help.form.category.ph':'Sélectionner…',
    'help.form.category.bug':'Problème technique ou bug',
    'help.form.category.billing':'Facturation et abonnement',
    'help.form.category.access':'Accès, permissions ou authentification',
    'help.form.category.integration':'Intégrations et connecteurs',
    'help.form.category.migration':'Migration et import de données',
    'help.form.category.feature':'Demande de fonctionnalité',
    'help.form.category.training':'Formation et prise en main',
    'help.form.category.security':'Sécurité et conformité',
    'help.form.category.other':'Autre',
    'help.form.email':'Votre e-mail',
    'help.form.subject':'Objet',
    'help.form.subject.ph':'Résumez en une ligne',
    'help.form.description':'Description',
    'help.form.description.optional':'(facultatif)',
    'help.form.description.ph':'Décrivez le problème ou votre demande…',
    'help.form.submit':'Envoyer la demande',
    'help.success.title':'Demande envoyée',
    'help.success.sub':'Notre équipe vous répond à l\'adresse indiquée.',
    'help.success.new':'Nouvelle demande',
    'help.links.title':'Accès rapide',
    'help.link.settings':'Paramètres du compte',
    'help.link.connectors':'Connecteurs & intégrations',
    'help.link.team':'Gestion de l\'équipe',
    'help.link.audit':'Journal d\'audit',
    'help.guides.title':'Guides & documentation',
    'help.guide.it':'Guide de configuration IT',
    'help.guide.client':'Présentation client NexHire EIP',
    'help.support.status':'Support disponible',
    'help.support.hours':'Lun – Ven · 9 h – 17 h EST',
    'settings.logo.label':'Logo de l\'organisation',
    'settings.logo.hint':'Cliquer pour téléverser un logo',
    'settings.logo.formats':'PNG, JPG ou SVG · max 2 Mo',
    'settings.brand.color':'Couleur de marque',
    'settings.brand.save':'Enregistrer le branding',
    'settings.brand.saved':'Branding mis à jour.',
    'settings.org.type':'Type d\'organisation',
    'settings.currency':'Devise',
    'settings.monthly.report.title':'Rapport mensuel automatique',
    'settings.monthly.report.desc':'Un rapport d\'activité est envoyé automatiquement par courriel le <strong>1er de chaque mois</strong> à l\'administrateur de l\'organisation — KPIs, économies identifiées, santé des départements, licences expirant bientôt.',
    'settings.monthly.report.btn':'Envoyer le rapport maintenant',
    'settings.monthly.enabled':'Activé',
  },
  en: {
    ...
    'audit.click.hint':'Click a row to see full details.',
    'org.title':'Business Intelligence','org.refresh':'↻ Refresh',
    'org.tab.dashboard':'🏛️ Dashboard','org.tab.copilot':'🤖 Executive Copilot',
    'org.dept.health':'Department health',
    'org.legend.healthy':'Healthy','org.legend.warning':'Warning','org.legend.risk':'At risk',
    'org.loading':'Loading…',
    'security.title':'Security Dashboard',
    'security.score.label':'Security score',
    'security.score.loading':'Loading…',
    'security.kpi.mfa':'MFA enabled',
    'security.kpi.alerts':'Unhandled alerts',
    'security.kpi.compliance':'Law 25 compliance',
    'security.alerts.title':'Security alerts',
    'security.alerts.refresh':'Refresh',
    'security.login.title':'Logins — last 7 days',
    'security.ip.title':'Recent login IPs',
    'security.mfa.title':'MFA management',
    'security.mfa.require':'Require MFA organization-wide',
    'security.mfa.desc':'Users can enable their MFA in <strong>Settings → Security</strong>. You can require MFA for all organization members.',
    'team.tab.executive':'🎯 Executive View','team.tab.effectifs':'👥 Staff',
    'team.tab.departements':'🏢 Departments','team.tab.structure':'📊 Structure',
    'team.tab.prestataires':'🤝 Contractors',
    'team.structure.title':'📊 Org chart','team.structure.refresh':'↻ Refresh',
    'team.contractors.title':'🤝 External contractors','team.contractors.add':'+ Add',
    'team.contractors.desc':'Consultants, contractors, vendors and subcontractors linked to your organization or specific departments.',
    'team.role.requests':'⏳ Role elevation requests',
    'billing.title':'Billing & subscription',
    'billing.subtitle':'Manage your NexHire EIP plan',
    'billing.refresh':'↺ Refresh',
    'billing.eyebrow':'Simple pricing · Start free · Pay when ready',
    'billing.trial.pill':'14-day full trial included · Access to all connectors · No card required',
    'billing.plan.starter.target':'SMB · Firms · 10–50 employees',
    'billing.plan.professional.target':'SMB · Municipalities · 50–500 employees',
    'billing.plan.enterprise.target':'Hospitals · Universities · Large enterprises',
    'billing.plan.featured':'Main plan',
    'billing.plan.enterprise.note':'Custom quote · Annual contract',
    'billing.btn.trial':'Start free trial',
    'billing.btn.trial.sub':'14 days free · No commitment',
    'billing.btn.contact':'Contact us →',
    'billing.btn.contact.sub':'Guided deployment · Guaranteed SLA',
    'billing.quota.title':'Usage this month',
    'billing.quota.loading':'Loading…',
    'billing.portal.btn':'Manage subscription via Stripe →',
    'billing.portal.desc':'Change your plan, download invoices, update payment method.',
    'help.hero.badge':'Help center',
    'help.hero.title':'How can we help you?',
    'help.hero.sub':'Documentation, guides and technical support for NexHire EIP',
    'help.topics.connectors.title':'Connectors',
    'help.topics.connectors.desc':'M365, Jira, SAP, Salesforce…',
    'help.topics.team.title':'Organization & team',
    'help.topics.team.desc':'Members, roles, departments',
    'help.topics.security.title':'Security & compliance',
    'help.topics.security.desc':'RLS, MFA, audit, GDPR',
    'help.topics.billing.title':'Billing',
    'help.topics.billing.desc':'Plans, subscription, quotas',
    'help.faq.title':'Frequently asked questions',
    'help.contact.title':'Contact support',
    'help.contact.sub':'Response within <strong>24 h</strong> business days · Bilingual FR / EN team',
    'help.form.category':'Category',
    'help.form.category.ph':'Select…',
    'help.form.category.bug':'Technical issue or bug',
    'help.form.category.billing':'Billing and subscription',
    'help.form.category.access':'Access, permissions or authentication',
    'help.form.category.integration':'Integrations and connectors',
    'help.form.category.migration':'Data migration and import',
    'help.form.category.feature':'Feature request',
    'help.form.category.training':'Training and onboarding',
    'help.form.category.security':'Security and compliance',
    'help.form.category.other':'Other',
    'help.form.email':'Your email',
    'help.form.subject':'Subject',
    'help.form.subject.ph':'Summarize in one line',
    'help.form.description':'Description',
    'help.form.description.optional':'(optional)',
    'help.form.description.ph':'Describe the issue or your request…',
    'help.form.submit':'Send request',
    'help.success.title':'Request sent',
    'help.success.sub':'Our team will reply to the address provided.',
    'help.success.new':'New request',
    'help.links.title':'Quick access',
    'help.link.settings':'Account settings',
    'help.link.connectors':'Connectors & integrations',
    'help.link.team':'Team management',
    'help.link.audit':'Audit log',
    'help.guides.title':'Guides & documentation',
    'help.guide.it':'IT configuration guide',
    'help.guide.client':'NexHire EIP client presentation',
    'help.support.status':'Support available',
    'help.support.hours':'Mon – Fri · 9 am – 5 pm EST',
    'settings.logo.label':'Organization logo',
    'settings.logo.hint':'Click to upload a logo',
    'settings.logo.formats':'PNG, JPG or SVG · max 2 MB',
    'settings.brand.color':'Brand color',
    'settings.brand.save':'Save branding',
    'settings.brand.saved':'Branding updated.',
    'settings.org.type':'Organization type',
    'settings.currency':'Currency',
    'settings.monthly.report.title':'Automatic monthly report',
    'settings.monthly.report.desc':'An activity report is automatically emailed on the <strong>1st of each month</strong> to the organization administrator — KPIs, identified savings, department health, expiring licenses.',
    'settings.monthly.report.btn':'Send report now',
    'settings.monthly.enabled':'Enabled',
  },
  es: {
    ...
    'audit.click.hint':'Haz clic en una fila para ver los detalles completos.',
    'org.title':'Inteligencia Empresarial','org.refresh':'↻ Actualizar',
    'org.tab.dashboard':'🏛️ Panel','org.tab.copilot':'🤖 Copilot Ejecutivo',
    'org.dept.health':'Salud de los departamentos',
    'org.legend.healthy':'Sano','org.legend.warning':'Atención','org.legend.risk':'En riesgo',
    'org.loading':'Cargando…',
    'security.title':'Panel de Seguridad',
    'security.score.label':'Puntuación de seguridad',
    'security.score.loading':'Cargando…',
    'security.kpi.mfa':'MFA activado',
    'security.kpi.alerts':'Alertas sin tratar',
    'security.kpi.compliance':'Cumplimiento Ley 25',
    'security.alerts.title':'Alertas de seguridad',
    'security.alerts.refresh':'Actualizar',
    'security.login.title':'Inicios de sesión — últimos 7 días',
    'security.ip.title':'IPs de inicio de sesión recientes',
    'security.mfa.title':'Gestión MFA',
    'security.mfa.require':'Exigir MFA en la organización',
    'security.mfa.desc':'Los usuarios pueden activar su MFA en <strong>Configuración → Seguridad</strong>. Puedes exigir MFA para todos los miembros de la organización.',
    'team.tab.executive':'🎯 Vista Ejecutiva','team.tab.effectifs':'👥 Plantilla',
    'team.tab.departements':'🏢 Departamentos','team.tab.structure':'📊 Estructura',
    'team.tab.prestataires':'🤝 Prestadores',
    'team.structure.title':'📊 Organigrama','team.structure.refresh':'↻ Actualizar',
    'team.contractors.title':'🤝 Colaboradores externos','team.contractors.add':'+ Añadir',
    'team.contractors.desc':'Consultores, prestadores, proveedores y subcontratistas vinculados a tu organización o departamentos específicos.',
    'team.role.requests':'⏳ Solicitudes de elevación de rol',
    'billing.title':'Facturación y suscripción',
    'billing.subtitle':'Gestiona tu plan NexHire EIP',
    'billing.refresh':'↺ Actualizar',
    'billing.eyebrow':'Precios simples · Empieza gratis · Paga cuando estés listo',
    'billing.trial.pill':'14 días de prueba completa · Acceso a todos los conectores · Sin tarjeta requerida',
    'billing.plan.starter.target':'PYME · Despachos · 10–50 empleados',
    'billing.plan.professional.target':'PYME · Municipios · 50–500 empleados',
    'billing.plan.enterprise.target':'Hospitales · Universidades · Grandes empresas',
    'billing.plan.featured':'Plan principal',
    'billing.plan.enterprise.note':'Precio a consultar · Contrato anual',
    'billing.btn.trial':'Empezar prueba gratuita',
    'billing.btn.trial.sub':'14 días gratis · Sin compromiso',
    'billing.btn.contact':'Contáctanos →',
    'billing.btn.contact.sub':'Implementación guiada · SLA garantizado',
    'billing.quota.title':'Uso este mes',
    'billing.quota.loading':'Cargando…',
    'billing.portal.btn':'Gestionar suscripción via Stripe →',
    'billing.portal.desc':'Cambia tu plan, descarga facturas, actualiza el método de pago.',
    'help.hero.badge':'Centro de ayuda',
    'help.hero.title':'¿Cómo podemos ayudarte?',
    'help.hero.sub':'Documentación, guías y soporte técnico para NexHire EIP',
    'help.topics.connectors.title':'Conectores',
    'help.topics.connectors.desc':'M365, Jira, SAP, Salesforce…',
    'help.topics.team.title':'Organización y equipo',
    'help.topics.team.desc':'Miembros, roles, departamentos',
    'help.topics.security.title':'Seguridad y cumplimiento',
    'help.topics.security.desc':'RLS, MFA, auditoría, RGPD',
    'help.topics.billing.title':'Facturación',
    'help.topics.billing.desc':'Planes, suscripción, cuotas',
    'help.faq.title':'Preguntas frecuentes',
    'help.contact.title':'Contactar soporte',
    'help.contact.sub':'Respuesta en <strong>24 h</strong> hábiles · Equipo bilingüe FR / EN',
    'help.form.category':'Categoría',
    'help.form.category.ph':'Seleccionar…',
    'help.form.category.bug':'Problema técnico o error',
    'help.form.category.billing':'Facturación y suscripción',
    'help.form.category.access':'Acceso, permisos o autenticación',
    'help.form.category.integration':'Integraciones y conectores',
    'help.form.category.migration':'Migración e importación de datos',
    'help.form.category.feature':'Solicitud de funcionalidad',
    'help.form.category.training':'Formación y puesta en marcha',
    'help.form.category.security':'Seguridad y cumplimiento',
    'help.form.category.other':'Otro',
    'help.form.email':'Tu correo',
    'help.form.subject':'Asunto',
    'help.form.subject.ph':'Resume en una línea',
    'help.form.description':'Descripción',
    'help.form.description.optional':'(opcional)',
    'help.form.description.ph':'Describe el problema o tu solicitud…',
    'help.form.submit':'Enviar solicitud',
    'help.success.title':'Solicitud enviada',
    'help.success.sub':'Nuestro equipo responderá a la dirección indicada.',
    'help.success.new':'Nueva solicitud',
    'help.links.title':'Acceso rápido',
    'help.link.settings':'Configuración de cuenta',
    'help.link.connectors':'Conectores e integraciones',
    'help.link.team':'Gestión del equipo',
    'help.link.audit':'Registro de auditoría',
    'help.guides.title':'Guías y documentación',
    'help.guide.it':'Guía de configuración IT',
    'help.guide.client':'Presentación cliente NexHire EIP',
    'help.support.status':'Soporte disponible',
    'help.support.hours':'Lun – Vie · 9 h – 17 h EST',
    'settings.logo.label':'Logo de la organización',
    'settings.logo.hint':'Clic para subir un logo',
    'settings.logo.formats':'PNG, JPG o SVG · max 2 MB',
    'settings.brand.color':'Color de marca',
    'settings.brand.save':'Guardar branding',
    'settings.brand.saved':'Branding actualizado.',
    'settings.org.type':'Tipo de organización',
    'settings.currency':'Divisa',
    'settings.monthly.report.title':'Informe mensual automático',
    'settings.monthly.report.desc':'Un informe de actividad se envía automáticamente por correo el <strong>1 de cada mes</strong> al administrador de la organización — KPIs, ahorros identificados, salud de los departamentos, licencias próximas a expirar.',
    'settings.monthly.report.btn':'Enviar informe ahora',
    'settings.monthly.enabled':'Activado',
  },
};
...
const _HELP_DOCS = [
  ...
  },
  {
    ...
    items: [
      { q: "Comment fonctionne l'assistant IA", a: "L'assistant interroge en temps réel vos connecteurs actifs (M365, Jira, SAP, etc.) et vos données internes (budgets, contrats, licences) pour répondre en langage naturel. Sélectionnez le mode Enterprise, Municipal ou Recrutement selon votre contexte. Si un connecteur est déconnecté, l'agent indique qu'il utilise des données simulées." },
      { q: "Exemples de questions à poser à l'agent", a: "Licences : 'Combien de licences Microsoft 365 ne sont pas utilisées ?' — Sécurité : 'Y a-t-il des admins sans MFA dans notre tenant ?' — IT : 'Montre-moi les appareils non conformes dans Intune.' — Jira : 'Quels tickets sont bloqués ce sprint ?' ou 'Résume les tickets par priorité dans le projet NEXH.' — Finance : 'Quelles factures QuickBooks sont impayées depuis plus de 60 jours ?' — Budget : 'Quel département a le plus dépassé son budget ce mois-ci ?' — Contrats : 'Quels contrats expirent dans les 30 prochains jours ?'" },
      { q: "Quota de requêtes", a: "Chaque organisation dispose d'un quota mensuel de requêtes IA (visible en bas de la sidebar et dans Paramètres). Le quota se renouvelle automatiquement chaque mois. En cas de dépassement, les requêtes sont bloquées jusqu'au renouvellement. Contactez support@nexhire.ca pour augmenter votre quota." },
  ...
  {
    title: "🔌 Configuration des connecteurs — Guide complet",
    items: [
      { q: "Comment fonctionne l'authentification OAuth", a: "Les connecteurs OAuth (M365, Jira, Salesforce, HubSpot, Slack, Google Workspace) redirigent vers le portail du fournisseur pour autoriser NexHire. Vos identifiants ne sont jamais transmis à NexHire — seul un token chiffré (Fernet AES-128) est stocké et révocable à tout moment depuis le portail du fournisseur." },
      { q: "Connecter Microsoft 365 (Entra ID)", a: "1. Intégrations → Microsoft 365 → Connecter. 2. Vous êtes redirigé vers le portail Microsoft. 3. Connectez-vous avec un compte Global Admin ou Cloud App Admin. 4. Acceptez les permissions demandées. 5. NexHire collecte les données en arrière-plan (~2 min) — le statut passe à Actif (fond vert). Permissions requises sur votre tenant : User.Read.All, Organization.Read.All, Reports.Read.All, AuditLog.Read.All (pour le suivi MFA), DeviceManagementManagedDevices.Read.All (pour Intune). Ce que NexHire analyse : licences non utilisées, comptes sans MFA, admins globaux redondants, appareils Intune non conformes, contrats et documents SharePoint. Prérequis : tenant Entra ID actif — sans tenant M365, contactez support@nexhire.ca." },
      { q: "Connecter Jira / Confluence (Atlassian)", a: "1. Intégrations → Jira / Confluence → Connecter. 2. Vous êtes redirigé vers Atlassian. 3. Sélectionnez votre site (ex. monentreprise.atlassian.net) et autorisez l'accès. 4. NexHire importe tickets, sprints, projets et pages Confluence. Prérequis : compte Jira Cloud avec rôle Project Admin ou Site Admin." },
      { q: "Connecter Salesforce CRM", a: "1. Intégrations → Salesforce → Connecter. 2. Vous êtes redirigé vers Salesforce. 3. Connectez-vous avec un compte admin Salesforce et autorisez la Connected App NexHire. 4. NexHire importe Comptes, Leads, Opportunités et Tickets. Prérequis : édition Professional, Enterprise ou Unlimited. Vérifiez que votre IP est dans la liste blanche Salesforce si applicable." },
      { q: "Connecter ServiceNow (identifiants directs)", a: "ServiceNow utilise une connexion par identifiants (pas OAuth). 1. Intégrations → ServiceNow → Configurer. 2. Renseignez : URL de l'instance (ex. https://monentreprise.service-now.com), Nom d'utilisateur, Mot de passe. 3. Cliquez Enregistrer. NexHire accède aux Incidents, Changements et CMDB. Conseil : créez un compte de service dédié avec rôle itil ou admin_read_only." },
      { q: "Connecter Zendesk (API Token)", a: "1. Dans Zendesk Admin Center → Apps & Integrations → API → API Token → Add API token. Copiez le token. 2. Intégrations → Zendesk → Configurer. 3. Renseignez : Sous-domaine (ex. monentreprise, sans .zendesk.com), Email de l'admin, API Token. 4. Cliquez Enregistrer. NexHire accède aux tickets, agents et métriques SLA." },
      { q: "Connecter SAP (API Hub)", a: "1. Récupérez l'URL de votre instance S/4HANA et les identifiants d'accès API. 2. Intégrations → SAP → Configurer. 3. Renseignez : URL de l'API SAP (ex. https://host:port/sap/opu/odata/sap/), Utilisateur SAP, Mot de passe. 4. Cliquez Enregistrer. Prérequis : rôle d'accès en lecture API dans SAP." },
      { q: "Connecter Workday (Client Credentials)", a: "1. Dans Workday, créez une application OAuth : Workday → Register API Client. Notez le Client ID, Client Secret et l'URL du Tenant. 2. Intégrations → Workday → Configurer. 3. Renseignez : URL du Tenant, Client ID, Client Secret, Refresh Token (si applicable). 4. Cliquez Enregistrer. Prérequis : rôle Integration System Security Group dans Workday." },
      { q: "Connecter Autotask / Datto (Clé API)", a: "1. Dans Autotask : Admin → API Users → New API User. Créez un utilisateur avec le rôle API Only. Copiez le Username et la clé secrète. 2. Intégrations → Autotask → Configurer. 3. Renseignez le nom d'utilisateur API et la clé secrète. 4. Cliquez Enregistrer. NexHire accède aux tickets PSA, projets, facturation et temps." },
      { q: "Connecter QuickBooks Online", a: "1. Intégrations → QuickBooks → Connecter via Intuit. 2. Vous êtes redirigé vers Intuit — connectez-vous et autorisez NexHire à accéder à votre entreprise QuickBooks. 3. Le statut passe à Actif. Ce que NexHire analyse : factures envoyées et impayées, dépenses par catégorie, bilan simplifié, flux de trésorerie. Exemples de questions à l'agent : 'Quelles factures sont en retard de plus de 30 jours ?' ou 'Résume les dépenses de ce trimestre par catégorie'. Prérequis : compte QuickBooks Online actif." },
      { q: "Statuts des connecteurs et résolution d'erreurs", a: "Actif (fond vert) : connexion opérationnelle, données réelles. En attente : configuration incomplète. Erreur (fond rouge) : token expiré ou permissions révoquées. Action : cliquez sur le connecteur en erreur → Reconnecter ou Reconfigurer. Si l'erreur persiste, vérifiez que les permissions du compte de service n'ont pas été modifiées côté fournisseur. Contactez support@nexhire.ca si le problème dure plus de 24h." },
      { q: "Données simulées vs réelles", a: "Si un connecteur est déconnecté ou en erreur, l'agent utilise des données de démonstration signalées par une bannière orange ⚠️. Les données réelles nécessitent un connecteur en statut Actif (fond vert). Vous pouvez vérifier l'origine des données dans la réponse de l'agent (icône ⚠️ Données simulées)." },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      { q: "Comment les économies sont calculées", a: "NexHire analyse 4 sources d'économies : 1. Surplus de licences (stock non assigné au-delà du buffer déclaré × coût unitaire mensuel). 2. Outils en doublon (même catégorie fonctionnelle, ≥ 3 actifs — économie estimée à 40 % du coût combiné). 3. Contrats à renouveler avec potentiel de négociation (% déclaré × valeur annuelle). 4. Microsoft 365 : sur-dimensionnement de plan et licences d'inactifs détectés via Graph API. Les économies sont exprimées en $/mois et $/an." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Authentification et sécurité", a: "Authentification par JWT ES256 (tokens d'accès 30 min, refresh 30 jours). Les tokens OAuth des connecteurs sont chiffrés avec Fernet avant stockage." },
  ...
  {
    title: "🔐 MFA — Authentification multi-facteurs",
    items: [
      { q: "Qu'est-ce que le MFA et pourquoi est-ce important", a: "Le MFA (Multi-Factor Authentication) ajoute une étape de vérification en plus du mot de passe : code SMS, application d'authentification ou clé de sécurité physique. Sans MFA, un mot de passe compromis suffit pour accéder aux données de votre organisation. NexHire surveille le statut MFA de vos administrateurs pour évaluer votre niveau de sécurité." },
      { q: "Voir le statut MFA dans NexHire", a: "Onglet Conformité → section Identité et accès. NexHire détecte automatiquement les administrateurs sans MFA activé via votre connecteur Microsoft 365 (Entra ID). Chaque admin sans MFA est listé comme un risque critique. Ce risque se résout automatiquement une fois le MFA activé côté M365 et la synchronisation relancée." },
      { q: "Activer le MFA pour vos administrateurs (Microsoft 365)", a: "1. Connectez-vous au Centre d'administration M365 (admin.microsoft.com) avec un compte Global Admin. 2. Allez dans Utilisateurs → Utilisateurs actifs → Authentification multi-facteurs. 3. Sélectionnez l'administrateur → Activer. 4. L'utilisateur configure sa méthode lors de sa prochaine connexion (application Microsoft Authenticator recommandée). 5. Dans NexHire : Conformité → Synchroniser pour mettre à jour le statut." },
      { q: "MFA avec d'autres fournisseurs d'identité", a: "Si vous utilisez Okta, Google Workspace ou un IdP SSO tiers, configurez le MFA dans ce fournisseur — NexHire lira l'état via le connecteur correspondant. Pour les comptes NexHire natifs (sans SSO), le MFA natif est en cours de déploiement. Contactez support@nexhire.ca pour être notifié à la disponibilité." },
      { q: "Risque 'Admins sans MFA' — comment le résoudre", a: "1. Notez les comptes listés dans Conformité → Identité et accès. 2. Activez le MFA pour ces comptes (voir étapes ci-dessus). 3. Relancez une synchronisation manuelle : Conformité → Synchroniser. 4. Si le risque persiste après 24h, vérifiez que le connecteur M365 est Actif et que les permissions incluent la lecture des méthodes d'authentification. Contactez support@nexhire.ca en cas de blocage." },
    ],
  },
  {
    title: "🔑 SSO — Authentification unique (Single Sign-On)",
    items: [
      { q: "Qu'est-ce que le SSO et ses avantages", a: "Le SSO (Single Sign-On) permet à vos utilisateurs de se connecter à NexHire avec leurs identifiants d'entreprise existants (Microsoft, Google, Okta) sans créer un mot de passe séparé. Avantages : connexion en un clic, gestion centralisée des accès, révocation immédiate lors d'un départ et conformité LPRPDE renforcée." },
      { q: "Protocoles et fournisseurs supportés", a: "NexHire supporte SAML 2.0 et OpenID Connect (OIDC). Fournisseurs compatibles : Microsoft Entra ID (Azure AD), Okta, Google Workspace, ADFS. D'autres fournisseurs SAML 2.0 standard peuvent être configurés sur demande. Contactez support@nexhire.ca avec le nom de votre fournisseur d'identité." },
      { q: "Comment activer le SSO pour votre organisation", a: "Le SSO est activé par l'équipe NexHire sur demande. Étapes : 1. Envoyez un email à support@nexhire.ca avec : nom de votre organisation, fournisseur SSO (ex. Microsoft Entra ID), domaine de messagerie (ex. @monentreprise.com). 2. Vous recevrez un fichier de métadonnées NexHire (XML SAML) à configurer dans votre fournisseur d'identité. 3. Testez avec un compte pilote. 4. Déployez pour tous les utilisateurs. Délai estimé : 1–3 jours ouvrables." },
      { q: "Configurer le SSO avec Microsoft Entra ID", a: "1. Centre d'administration Entra ID → Applications d'entreprise → Nouvelle application → Créer votre propre application → NexHire EIP. 2. Onglet Authentification unique → SAML. 3. Renseignez l'URL de l'entité et l'URL ACS fournies par le support NexHire. 4. Mappez les attributs : email (user.mail), nom (user.displayname). 5. Téléchargez le certificat SAML et envoyez-le au support NexHire. 6. Assignez les utilisateurs et groupes dans l'onglet Utilisateurs et groupes." },
      { q: "Configurer le SSO avec Okta", a: "1. Console Okta admin → Applications → Créer une intégration d'app → SAML 2.0. 2. Nommez l'application (ex. NexHire EIP). 3. Renseignez l'URL SSO et l'URI d'audience fournis par le support NexHire. 4. Configurez les attributs (email, firstName, lastName). 5. Téléchargez les métadonnées Okta et envoyez-les au support NexHire. 6. Assignez l'application aux utilisateurs ou groupes." },
      { q: "Ce qui change après activation du SSO", a: "Un bouton 'Se connecter avec [votre fournisseur]' apparaît sur la page de connexion. Les comptes existants sont liés automatiquement si l'email correspond. La gestion des mots de passe NexHire est désactivée pour les comptes SSO. La révocation dans votre IdP désactive immédiatement l'accès à NexHire. Les admins conservent un accès local de secours (backup code) en cas de panne IdP." },
    ],
  },
  {
    title: "💰 Budgets, transactions et dépenses",
    items: [
      { q: "Où trouver la gestion des budgets", a: "Onglet Dépenses (icône 💳 dans la sidebar). C'est ici que vous ajoutez les budgets par département, enregistrez les transactions et suivez les dépassements. Cet onglet est prioritairement visible pour les rôles Finance et Approvisionnement, mais les admins y ont accès complet." },
      { q: "Ajouter un budget pour un département", a: "Dépenses → Budgets → + Nouveau budget. Sélectionnez le département, renseignez le montant alloué (annuel), la devise et la période (exercice fiscal). NexHire calcule automatiquement le taux d'utilisation au fil des transactions enregistrées et génère une alerte si le seuil de 95 % est dépassé." },
      { q: "Enregistrer une transaction", a: "Dépenses → Transactions → + Nouvelle transaction. Renseignez : département, catégorie, montant, date, description et fournisseur. La transaction est immédiatement prise en compte dans le calcul du budget consommé et dans les rapports d'export." },
      { q: "Catégories de dépenses disponibles", a: "NexHire propose des catégories standard : Logiciels & licences, Matériel, Services professionnels, Hébergement cloud, Télécommunications, Formation, Marketing, RH, Autres. Vous pouvez également créer des catégories personnalisées via Paramètres → Catégories de dépenses (admins uniquement)." },
      { q: "Alertes de dépassement de budget", a: "NexHire génère automatiquement une alerte (onglet Vue d'ensemble → bannière Alertes financières) lorsqu'un département atteint 95 % de son budget alloué. Un risque critique est créé dans l'onglet Conformité → Risques si le dépassement dépasse 105 %. Ces alertes sont également visibles dans les rapports exportés." },
    ],
  },
  {
    title: "🖥️ Parc IT — Applications, Contrats et Licences",
    items: [
      ...
      { q: "Coûts cachés des licences — ce que NexHire surveille", a: "NexHire identifie 4 coûts cachés courants : 1. Surplus de stock (licences payées sans usage au-delà du buffer déclaré). 2. Licences annuelles pour usage temporaire — un stagiaire 4 mois avec une licence annuelle = 8 mois payés pour rien. 3. Sur-dimensionnement de plan — utilisateurs avec une licence Enterprise qui n'utilisent que l'email (plan Basique suffisant). 4. Licences non assignées après un départ — compte désactivé, licence toujours facturée. Pour les connecteurs Microsoft 365, NexHire détecte automatiquement les cas 3 et 4 via les données Graph réelles." },
    ],
  },
  {
    title: "🛒 Marketplace NexHire",
    items: [
      { q: "Qu'est-ce que la Marketplace NexHire", a: "La Marketplace regroupe des connecteurs et extensions premium que vous pouvez activer en un clic pour enrichir votre expérience NexHire. Elle inclut des connecteurs supplémentaires (BambooHR, QuickBooks, HubSpot), des templates de rapports sectoriels et des modules d'analyse avancée." },
      { q: "Comment activer un connecteur depuis la Marketplace", a: "Marketplace → parcourez les catégories (RH, Finance, CRM, Support, etc.) → cliquez sur le connecteur souhaité → Activer. Si le connecteur nécessite une configuration (API key, OAuth), un formulaire s'affiche. Une fois activé, il apparaît dans votre onglet Intégrations avec le statut En attente de configuration." },
      { q: "Connecteurs gratuits vs premium", a: "Les connecteurs de base (M365, Jira, Salesforce, ServiceNow) sont inclus dans tous les plans. Les connecteurs premium (SAP, Workday, Autotask, BambooHR, QuickBooks) sont disponibles selon votre plan d'abonnement. Contactez support@nexhire.ca pour connaître les connecteurs disponibles dans votre plan." },
      { q: "Connecteurs en fonction des départements", a: "Dans Intégrations → [nom du connecteur] → Accès par département. Vous pouvez restreindre un connecteur à un ou plusieurs départements. Exemple : Zendesk uniquement pour le département Support IT, Salesforce uniquement pour Commercial. Les membres des autres départements ne verront pas ces données dans l'agent IA. Accès par défaut selon le type de département — Finance : budgets et transactions ; Approvisionnement : contrats et fournisseurs ; Technologies de l'information : licences, applications et parc IT ; Direction / Administration : tous les modules. Si un membre ne voit pas un onglet, un admin doit l'assigner au bon département via Organisation → Départements." },
    ],
  },
  {
    title: "📄 Documents et recherche interne",
    items: [
      { q: "Téléverser un document PDF", a: "Onglet Rapports → sous-onglet Documents → + Téléverser un document. Choisissez votre fichier PDF, sélectionnez le Département propriétaire (ou laissez 'Accessible à toute l'organisation' pour un document partagé), puis cliquez Extraire le texte. Le document est ensuite indexé et disponible dans la recherche interne du département sélectionné." },
      { q: "Rechercher dans vos documents internes", a: "Chaque module dispose d'un sous-onglet Recherche (🔍) pour interroger vos documents en langage naturel. Exemples : 'Quelle est notre politique de remboursement de frais ?' / 'Quelles sont les clauses de résiliation du contrat avec le fournisseur X ?' / 'Résume les procédures de sécurité informatique.' La recherche ne retourne que les documents de votre département et les documents partagés à toute l'organisation." },
      { q: "Qui peut voir mes documents uploadés", a: "Les documents sont strictement isolés par département. Un employé du département Finance ne peut pas accéder aux documents du département IT. Seuls les documents marqués 'Accessible à toute l'organisation' sont visibles par tous. Les admins peuvent voir tous les documents de l'organisation." },
      { q: "Formats de documents acceptés", a: "Actuellement NexHire accepte les fichiers PDF. Le texte est extrait automatiquement et indexé pour la recherche IA. Les documents de grande taille (>10 Mo) peuvent prendre quelques secondes de plus pour être traités. Pour d'autres formats (Word, Excel), convertissez en PDF avant de téléverser." },
    ],
  },
  {
    title: "📋 Rapports automatiques et planification",
    items: [
      { q: "Rapport mensuel automatique — comment l'activer", a: "Paramètres → Notifications & Rapports → Rapport mensuel automatique → Activer. Configurez : fréquence (mensuelle, trimestrielle), destinataires (email des admins ou liste personnalisée), format (PDF Executive, Excel complet ou les deux). Le rapport est généré automatiquement le 1er de chaque mois et envoyé par email à l'adresse configurée." },
      { q: "Contenu du rapport mensuel automatique", a: "Le rapport mensuel inclut : Vue d'ensemble des KPIs (score d'efficacité, économies identifiées), état des budgets par département (alloué vs consommé), contrats à renouveler dans les 30 jours, risques actifs (critical/high), top 5 opportunités d'optimisation et évolution mois sur mois." },
      { q: "Personnaliser le rapport automatique", a: "Paramètres → Rapports → Personnalisation. Vous pouvez choisir quelles sections inclure, ajouter le logo de l'organisation (activé par défaut si uploadé), sélectionner la devise d'affichage et choisir la langue du rapport (FR, EN, ES). Le rapport utilise toujours les données de la période précédente complète." },
      { q: "Exporter un rapport manuellement", a: "Onglet Rapports → sélectionnez la période dans le sélecteur de dates → cliquez sur le bouton d'export souhaité (PDF 📄, Word 📝, Excel 📊, PowerPoint 📑). Le rapport est généré en quelques secondes et téléchargé dans votre navigateur. Le logo et les couleurs de marque sont automatiquement intégrés." },
    ],
  },
];

...
(function () {
  ...
  const S = {
    fr: {
      ...
      /* ── Shell — recherche & toast ──────────────────────────────── */
      'ws.search.results':           'Résultats',
      'ws.search.quick':             'Navigation rapide',
      'ws.search.no_results':        'Aucun résultat pour « {q} »',
      'ws.toast.soon':               'module en cours de déploiement',

      /* ── ATLAS Onboard — UI ─────────────────────────────────────── */
      'ws.ob.atlas.label':           'ATLAS vous accueille',
      'ws.ob.atlas.sub':             'Votre assistant IA personnel',
      'ws.ob.welcome':               'Bienvenue dans',
      'ws.ob.skip':                  'Je connais déjà ce module →',

      /* ── ATLAS Onboard — Sales Intelligence ─────────────────────── */
      'ws.ob.sales.desc':            'Votre centre de commande IA pour automatiser la prospection, piloter les campagnes et fermer plus de deals.',
      'ws.ob.sales.b1':              'ATLAS identifie vos meilleurs leads et les classe automatiquement par potentiel',
      'ws.ob.sales.b2':              'Vos agents IA prospectent et qualifient 24h/24 pendant que vous dormez',
      'ws.ob.sales.b3':              'Pipeline commercial en temps réel avec prédictions de closing par IA',
      'ws.ob.sales.a1':              'Configurer',
      'ws.ob.sales.a1sub':           'Connecter votre CRM',
      'ws.ob.sales.a2':              'Importer',
      'ws.ob.sales.a2sub':           'Charger vos prospects',
      'ws.ob.sales.a3':              'Commencer',
      'ws.ob.sales.a3sub':           'Voir le tableau de bord',

      /* ── ATLAS Onboard — Recommandations ─────────────────────────── */
      'ws.ob.rec.desc':              "ATLAS analyse votre score IMAI et vous propose un plan d'adoption IA prioritisé sur 12 semaines.",
      'ws.ob.rec.b1':                'Score IMAI calculé sur 8 dimensions avec comparaison sectorielle',
      'ws.ob.rec.b2':                "Plan d'adoption en 3 phases avec jalons clairs et actions concrètes",
      'ws.ob.rec.b3':                'Suivi de progression et recalcul automatique à chaque action complétée',
      'ws.ob.rec.a1':                'Voir mon score',
      'ws.ob.rec.a1sub':             'Score IMAI actuel',
      'ws.ob.rec.a2':                'Mon plan',
      'ws.ob.rec.a2sub':             'Plan 12 semaines',
      'ws.ob.rec.a3':                'Commencer',
      'ws.ob.rec.a3sub':             'Première recommandation',

      /* ── ATLAS Onboard — Automatisation ──────────────────────────── */
      'ws.ob.aut.desc':              'Connectez vos processus métier à vos outils et laissez vos agents IA travailler à votre place.',
      'ws.ob.aut.b1':                "Déclenchez des workflows automatiques à partir d'événements AgentHub ou planifiés",
      'ws.ob.aut.b2':                "9 modèles prêts à l'emploi pour les cas d'usage les plus fréquents",
      'ws.ob.aut.b3':                'Connecteurs natifs Teams, Outlook, HubSpot, ServiceNow et 50+ autres',
      'ws.ob.aut.a1':                'Explorer',
      'ws.ob.aut.a1sub':             'Bibliothèque de modèles',
      'ws.ob.aut.a2':                'Configurer',
      'ws.ob.aut.a2sub':             'Activer les déclencheurs',
      'ws.ob.aut.a3':                'Créer',
      'ws.ob.aut.a3sub':             'Nouveau workflow',

      /* ── ATLAS Onboard — Marketplace ─────────────────────────────── */
      'ws.ob.mkt.desc':              'Découvrez et installez des espaces de travail préconfigurés, des agents IA et des connecteurs pour votre secteur.',
      'ws.ob.mkt.b1':                'Plus de 30 workspaces préconfigurés par secteur : entreprise, santé, éducation',
      'ws.ob.mkt.b2':                '9 agents IA spécialisés déployables en un clic',
      'ws.ob.mkt.b3':                '12 connecteurs certifiés pour vos outils existants',
      'ws.ob.mkt.a1':                'Workspaces',
      'ws.ob.mkt.a1sub':             'Catalogue par secteur',
      'ws.ob.mkt.a2':                'Agents IA',
      'ws.ob.mkt.a2sub':             'Explorer les agents',
      'ws.ob.mkt.a3':                'Connecteurs',
      'ws.ob.mkt.a3sub':             'Intégrations disponibles',

      /* ── ATLAS Onboard — Parc TI ─────────────────────────────────── */
      'ws.ob.ast.desc':              'Inventaire centralisé de tous vos équipements informatiques avec suivi des garanties et des coûts.',
      'ws.ob.ast.b1':                'Vue unifiée de tous vos actifs : serveurs, postes, réseau et imprimantes',
      'ws.ob.ast.b2':                "Alertes automatiques avant l'expiration des garanties pour éviter les surprises",
      'ws.ob.ast.b3':                'Coûts mensuels par actif et département pour optimiser votre budget TI',
      'ws.ob.ast.a1':                'Inventaire',
      'ws.ob.ast.a1sub':             'Voir tous les actifs',
      'ws.ob.ast.a2':                'Ajouter',
      'ws.ob.ast.a2sub':             'Enregistrer un actif',
      'ws.ob.ast.a3':                'Commencer',
      'ws.ob.ast.a3sub':             'Importer depuis CSV',

      /* ── ATLAS Onboard — Budget ──────────────────────────────────── */
      'ws.ob.bud.desc':              'Pilotez votre budget par catégorie et département avec un suivi alloué vs réel en temps réel.',
      'ws.ob.bud.b1':                'Tableau de bord financier avec alertes de dépassement budgétaire automatiques',
      'ws.ob.bud.b2':                'Prévisions IA basées sur les tendances historiques pour anticiper les besoins',
      'ws.ob.bud.b3':                'Module Coûts IA pour quantifier et optimiser votre investissement en intelligence artificielle',
      'ws.ob.bud.a1':                'Dashboard',
      'ws.ob.bud.a1sub':             'Vue consolidée',
      'ws.ob.bud.a2':                'Saisir',
      'ws.ob.bud.a2sub':             'Ajouter une entrée',
      'ws.ob.bud.a3':                'Prévisions',
      'ws.ob.bud.a3sub':             'Projections N+1',

      /* ── ATLAS Onboard — Contrats ────────────────────────────────── */
      'ws.ob.con.desc':              'Centralisez vos contrats fournisseurs et ne manquez plus aucun renouvellement critique.',
      'ws.ob.con.b1':                'Alertes proactives 90j, 30j et 7j avant chaque renouvellement important',
      'ws.ob.con.b2':                'ATLAS identifie les opportunités de négociation et les économies potentielles',
      'ws.ob.con.b3':                'Vue Fournisseurs consolidée pour maximiser votre levier de négociation',
      'ws.ob.con.a1':                'Mes contrats',
      'ws.ob.con.a1sub':             'Voir la liste',
      'ws.ob.con.a2':                'Ajouter',
      'ws.ob.con.a2sub':             'Nouveau contrat',
      'ws.ob.con.a3':                'Alertes',
      'ws.ob.con.a3sub':             'Renouvellements urgents',

      /* ── ATLAS Onboard — SSO & MFA ───────────────────────────────── */
      'ws.ob.sso.desc':              "Sécurisez l'accès à votre organisation avec la connexion unique et l'authentification multifacteur.",
      'ws.ob.sso.b1':                'Connectez Microsoft Entra ID, Google Workspace, Okta ou Auth0 en 3 minutes',
      'ws.ob.sso.b2':                "Activez le MFA pour toute l'organisation d'un seul clic — réduit les risques de 99,9%",
      'ws.ob.sso.b3':                'Surveillance complète : sessions actives, journal des connexions, alertes en temps réel',
      'ws.ob.sso.a1':                'Configurer SSO',
      'ws.ob.sso.a1sub':             'Choisir un fournisseur',
      'ws.ob.sso.a2':                'Activer MFA',
      'ws.ob.sso.a2sub':             'Protéger les comptes',
      'ws.ob.sso.a3':                'Sessions',
      'ws.ob.sso.a3sub':             'Voir les connexions',

      /* ── Notifications mock ──────────────────────────────────────── */
      'ws.notif.n1.title':           'Nouveau rapport disponible',
      'ws.notif.n1.sub':             'Rapport de maturité IA — Juin 2026',
      'ws.notif.n1.time':            'il y a 5 min',
      'ws.notif.n2.title':           'Diagnostic complété',
      'ws.notif.n2.sub':             'Score : 58/100 · Niveau Intermédiaire',
      'ws.notif.n2.time':            'il y a 2 h',
      'ws.notif.n3.title':           'ATLAS recommande une action',
      'ws.notif.n3.sub':             'Renforcer la gouvernance des données · Priorité élevée',
      'ws.notif.n3.time':            'il y a 1 j',
      'ws.notif.n4.title':           'Mise à jour AgentHub disponible',
      'ws.notif.n4.sub':             'AgentHub Platform v1.0 RC1',
      'ws.notif.n4.time':            'il y a 2 j',

      /* ── Éléments de recherche rapide ────────────────────────────── */
      'ws.si.dashboard.sub':         "Vue d'ensemble de votre organisation",
      'ws.si.diagnostic.sub':        'Évaluer la maturité IA de votre organisation',
      'ws.si.atlas.sub':             'Votre conseiller IA personnel',
      'ws.si.gouvernance.sub':       'Conformité et politiques de gouvernance',
      'ws.si.observatoire.sub':      'Tableau de bord du programme partenaire',
      ...
      'pl.invite.org':               'votre organisation',
      'pl.invite.role.user':         'Utilisateur',
      'pl.invite.role.manager':      'Manager',
      'pl.invite.role.admin':        'Administrateur',
      'pl.invite.banner.pre':        'Invitation reçue',
      'pl.invite.banner.join':       'Rejoignez',
      'pl.invite.banner.as':         'en tant que',
      'pl.invite.banner.cta':        'Connectez-vous ou créez un compte pour accepter.',
      'pl.login.err.creds':          'Courriel ou mot de passe incorrect.',
      'pl.login.err.fail':           'Connexion échouée. Veuillez réessayer.',
      'pl.network.error':            'Erreur réseau. Vérifiez votre connexion et réessayez.',
      'pl.network.short':            'Erreur réseau. Vérifiez votre connexion.',
      'pl.forgot.success':           'Un lien de réinitialisation a été envoyé à <strong>{email}</strong> si ce compte existe.',
      'pl.forgot.error':             "Erreur lors de l'envoi. Vérifiez l'adresse et réessayez.",
      'pl.signup.err.orgtype':       'Veuillez sélectionner le type de votre organisation.',
      'pl.signup.err.cgu':           "Vous devez accepter les conditions d'utilisation pour continuer.",
      'pl.signup.err.partner':       "Ce lien d'invitation n'est plus valide.",
      'pl.signup.err.invite':        "Un lien d'invitation est déjà en attente pour ce courriel.",
      'pl.signup.err.fail':          'Inscription échouée. Vérifiez les informations saisies.',
      'pl.signup.confirm.title':     'Connectez-vous pour accéder à votre espace',
      'pl.reset.err.mismatch':       'Les mots de passe ne correspondent pas.',
      'pl.reset.err.short':          'Le mot de passe doit contenir au moins 12 caractères.',
      'pl.reset.err.fail':           'Échec de la mise à jour. Réessayez ou demandez un nouveau lien.',
      'pl.reset.success':            'Mot de passe mis à jour avec succès. Vous pouvez maintenant vous connecter.',
      'pl.org.default':              'Mon organisation',
      'pl.mail.outlook':             'Ouvrir Outlook',
      'pl.mail.yahoo':               'Ouvrir Yahoo Mail',
...
/* ── Écran de bienvenue ───────────────────────────────────────────── */
    ...
    en: {
      ...
      /* ── Shell — search & toast ─────────────────────────────────── */
      'ws.search.results':           'Results',
      'ws.search.quick':             'Quick navigation',
      'ws.search.no_results':        'No results for « {q} »',
      'ws.toast.soon':               'module currently deploying',

      /* ── ATLAS Onboard — UI ─────────────────────────────────────── */
      'ws.ob.atlas.label':           'ATLAS welcomes you',
      'ws.ob.atlas.sub':             'Your personal AI assistant',
      'ws.ob.welcome':               'Welcome to',
      'ws.ob.skip':                  'I already know this module →',

      /* ── ATLAS Onboard — Sales Intelligence ─────────────────────── */
      'ws.ob.sales.desc':            'Your AI command centre to automate prospecting, drive campaigns, and close more deals.',
      'ws.ob.sales.b1':              'ATLAS identifies your best leads and ranks them automatically by potential',
      'ws.ob.sales.b2':              'Your AI agents prospect and qualify 24/7 while you sleep',
      'ws.ob.sales.b3':              'Real-time sales pipeline with AI-powered closing predictions',
      'ws.ob.sales.a1':              'Set up',
      'ws.ob.sales.a1sub':           'Connect your CRM',
      'ws.ob.sales.a2':              'Import',
      'ws.ob.sales.a2sub':           'Load your prospects',
      'ws.ob.sales.a3':              'Start',
      'ws.ob.sales.a3sub':           'View the dashboard',

      /* ── ATLAS Onboard — Recommendations ────────────────────────── */
      'ws.ob.rec.desc':              'ATLAS analyses your IMAI score and proposes a prioritised 12-week AI adoption plan.',
      'ws.ob.rec.b1':                'IMAI score calculated on 8 dimensions with industry benchmarking',
      'ws.ob.rec.b2':                '3-phase adoption plan with clear milestones and concrete actions',
      'ws.ob.rec.b3':                'Progress tracking with automatic recalculation after each completed action',
      'ws.ob.rec.a1':                'My score',
      'ws.ob.rec.a1sub':             'Current IMAI score',
      'ws.ob.rec.a2':                'My plan',
      'ws.ob.rec.a2sub':             '12-week plan',
      'ws.ob.rec.a3':                'Start',
      'ws.ob.rec.a3sub':             'First recommendation',

      /* ── ATLAS Onboard — Automation ──────────────────────────────── */
      'ws.ob.aut.desc':              'Connect your business processes to your tools and let your AI agents do the work.',
      'ws.ob.aut.b1':                'Trigger automatic workflows from AgentHub events or schedules',
      'ws.ob.aut.b2':                '9 ready-to-use templates for the most frequent use cases',
      'ws.ob.aut.b3':                'Native connectors for Teams, Outlook, HubSpot, ServiceNow and 50+ more',
      'ws.ob.aut.a1':                'Explore',
      'ws.ob.aut.a1sub':             'Template library',
      'ws.ob.aut.a2':                'Set up',
      'ws.ob.aut.a2sub':             'Enable triggers',
      'ws.ob.aut.a3':                'Create',
      'ws.ob.aut.a3sub':             'New workflow',

      /* ── ATLAS Onboard — Marketplace ─────────────────────────────── */
      'ws.ob.mkt.desc':              'Discover and install preconfigured workspaces, AI agents, and connectors for your industry.',
      'ws.ob.mkt.b1':                'Over 30 preconfigured workspaces by industry: enterprise, healthcare, education',
      'ws.ob.mkt.b2':                '9 specialised AI agents deployable with one click',
      'ws.ob.mkt.b3':                '12 certified connectors for your existing tools',
      'ws.ob.mkt.a1':                'Workspaces',
      'ws.ob.mkt.a1sub':             'Catalogue by industry',
      'ws.ob.mkt.a2':                'AI Agents',
      'ws.ob.mkt.a2sub':             'Explore agents',
      'ws.ob.mkt.a3':                'Connectors',
      'ws.ob.mkt.a3sub':             'Available integrations',

      /* ── ATLAS Onboard — IT Assets ───────────────────────────────── */
      'ws.ob.ast.desc':              'Centralised inventory of all your IT equipment with warranty and cost tracking.',
      'ws.ob.ast.b1':                'Unified view of all your assets: servers, workstations, network, and printers',
      'ws.ob.ast.b2':                'Automatic alerts before warranty expiry to avoid surprises',
      'ws.ob.ast.b3':                'Monthly costs per asset and department to optimise your IT budget',
      'ws.ob.ast.a1':                'Inventory',
      'ws.ob.ast.a1sub':             'View all assets',
      'ws.ob.ast.a2':                'Add',
      'ws.ob.ast.a2sub':             'Register an asset',
      'ws.ob.ast.a3':                'Start',
      'ws.ob.ast.a3sub':             'Import from CSV',

      /* ── ATLAS Onboard — Budget ──────────────────────────────────── */
      'ws.ob.bud.desc':              'Manage your budget by category and department with real-time allocated vs actual tracking.',
      'ws.ob.bud.b1':                'Financial dashboard with automatic budget overrun alerts',
      'ws.ob.bud.b2':                'AI forecasts based on historical trends to anticipate needs',
      'ws.ob.bud.b3':                'AI Costs module to quantify and optimise your AI investment',
      'ws.ob.bud.a1':                'Dashboard',
      'ws.ob.bud.a1sub':             'Consolidated view',
      'ws.ob.bud.a2':                'Enter',
      'ws.ob.bud.a2sub':             'Add an entry',
      'ws.ob.bud.a3':                'Forecasts',
      'ws.ob.bud.a3sub':             'N+1 projections',

      /* ── ATLAS Onboard — Contracts ───────────────────────────────── */
      'ws.ob.con.desc':              'Centralise your supplier contracts and never miss a critical renewal.',
      'ws.ob.con.b1':                'Proactive alerts 90d, 30d, and 7d before each important renewal',
      'ws.ob.con.b2':                'ATLAS identifies negotiation opportunities and potential savings',
      'ws.ob.con.b3':                'Consolidated supplier view to maximise your negotiating leverage',
      'ws.ob.con.a1':                'My contracts',
      'ws.ob.con.a1sub':             'View the list',
      'ws.ob.con.a2':                'Add',
      'ws.ob.con.a2sub':             'New contract',
      'ws.ob.con.a3':                'Alerts',
      'ws.ob.con.a3sub':             'Urgent renewals',

      /* ── ATLAS Onboard — SSO & MFA ───────────────────────────────── */
      'ws.ob.sso.desc':              'Secure access to your organisation with single sign-on and multi-factor authentication.',
      'ws.ob.sso.b1':                'Connect Microsoft Entra ID, Google Workspace, Okta, or Auth0 in 3 minutes',
      'ws.ob.sso.b2':                'Enable MFA for the entire organisation in one click — reduces risk by 99.9%',
      'ws.ob.sso.b3':                'Full monitoring: active sessions, connection log, real-time alerts',
      'ws.ob.sso.a1':                'Set up SSO',
      'ws.ob.sso.a1sub':             'Choose a provider',
      'ws.ob.sso.a2':                'Enable MFA',
      'ws.ob.sso.a2sub':             'Protect accounts',
      'ws.ob.sso.a3':                'Sessions',
      'ws.ob.sso.a3sub':             'View connections',

      /* ── Mock notifications ──────────────────────────────────────── */
      'ws.notif.n1.title':           'New report available',
      'ws.notif.n1.sub':             'AI Maturity Report — June 2026',
      'ws.notif.n1.time':            '5 min ago',
      'ws.notif.n2.title':           'Diagnostic completed',
      'ws.notif.n2.sub':             'Score: 58/100 · Intermediate Level',
      'ws.notif.n2.time':            '2 h ago',
      'ws.notif.n3.title':           'ATLAS recommends an action',
      'ws.notif.n3.sub':             'Strengthen data governance · High priority',
      'ws.notif.n3.time':            '1 day ago',
      'ws.notif.n4.title':           'AgentHub update available',
      'ws.notif.n4.sub':             'AgentHub Platform v1.0 RC1',
      'ws.notif.n4.time':            '2 days ago',

      /* ── Quick search items ──────────────────────────────────────── */
      'ws.si.dashboard.sub':         'Overview of your organisation',
      'ws.si.diagnostic.sub':        "Assess your organisation's AI maturity",
      'ws.si.atlas.sub':             'Your personal AI advisor',
      'ws.si.gouvernance.sub':       'Compliance and governance policies',
      'ws.si.observatoire.sub':      'Partner program dashboard',
      ...
      'pl.invite.role.manager':      'Manager',
      'pl.invite.role.admin':        'Administrator',
      'pl.invite.banner.pre':        'Invitation received',
      'pl.invite.banner.join':       'Join',
      'pl.invite.banner.as':         'as',
      'pl.invite.banner.cta':        'Sign in or create an account to accept.',
      'pl.login.err.creds':          'Incorrect email or password.',
      'pl.login.err.fail':           'Sign in failed. Please try again.',
      'pl.network.error':            'Network error. Check your connection and try again.',
      'pl.network.short':            'Network error. Check your connection.',
      'pl.forgot.success':           'A reset link has been sent to <strong>{email}</strong> if this account exists.',
      'pl.forgot.error':             'Error sending the email. Check the address and try again.',
      'pl.signup.err.orgtype':       'Please select your organisation type.',
      'pl.signup.err.cgu':           'You must accept the terms of use to continue.',
      'pl.signup.err.partner':       'This invitation link is no longer valid.',
      'pl.signup.err.invite':        'An invitation link is already pending for this email.',
      'pl.signup.err.fail':          'Sign up failed. Check the information entered.',
      'pl.signup.confirm.title':     'Sign in to access your space',
      'pl.reset.err.mismatch':       'Passwords do not match.',
      'pl.reset.err.short':          'Password must be at least 12 characters.',
      'pl.reset.err.fail':           'Update failed. Try again or request a new link.',
      'pl.reset.success':            'Password updated successfully. You can now sign in.',
      'pl.org.default':              'My organisation',
      'pl.mail.outlook':             'Open Outlook',
      'pl.mail.yahoo':               'Open Yahoo Mail',

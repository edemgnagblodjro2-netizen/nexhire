...
def oauth_callback(
    ...
    try:
        ...
        return RedirectResponse(url="/?oauth_error=network_error", status_code=302)
...
def refresh_token_if_needed(connector_type: str, org_id: str) -> dict | None:
    ...
    try:
        ...
        creds["expires_at"] = (datetime.now(UTC) + timedelta(seconds=tokens.get("expires_in", 3600))).isoformat()

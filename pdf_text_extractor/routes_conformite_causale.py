...
_DEMO_FRAMEWORKS = [
    {
        "id": "fw-iso27001", "name": "ISO 27001:2022", "icon": "🔒",
        "score": 68, "score_trend": +2, "status": "in_progress",
        "controls_total": 93, "controls_compliant": 63, "nonconformites": 8,
    ...
    {
        "id": "fw-loi25", "name": "Loi 25 (Québec)", "icon": "🇨🇦",
        "score": 81, "score_trend": +5, "status": "compliant",
        "controls_total": 18, "controls_compliant": 15, "nonconformites": 3,
    ...
    {
        "id": "fw-iso42001", "name": "ISO 42001 (IA)", "icon": "🤖",
        "score": 58, "score_trend": 0, "status": "in_progress",
        "controls_total": 38, "controls_compliant": 22, "nonconformites": 6,
...
_DEMO_NONCONFORMITES = {
    "fw-iso27001": [
        {
            "id": "nc-001", "framework_id": "fw-iso27001",
            "control_ref": "A.5.15", "control_name": "Contrôle d'accès",
        ...
        {
            "id": "nc-002", "framework_id": "fw-iso27001",
            "control_ref": "A.5.23", "control_name": "Sécurité des services cloud",
        ...
        {
            "id": "nc-003", "framework_id": "fw-iso27001",
            "control_ref": "A.5.26", "control_name": "Gestion des incidents",
        ...
        {
            "id": "nc-004", "framework_id": "fw-iso27001",
            "control_ref": "A.8.8", "control_name": "Gestion des vulnérabilités",
...
def create_action_plan(
    ...
    with get_db() as cur:
        ...
        """, (
            ap_id, nc_id, body.title, body.description, body.owner,
            body.due_date, body.playbook_id, body.orchestration_id, now,
        ))

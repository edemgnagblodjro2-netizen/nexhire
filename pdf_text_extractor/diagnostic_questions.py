...
QUESTIONS: list[dict] = [
    # ── Stratégie ─────────────────────────────────────────────────────────────
    {
        "code": "S1", "dimension": "strategie", "order": 1,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "S2", "dimension": "strategie", "order": 2,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "S_c1", "dimension": "strategie", "order": 3,
        "is_conditional": True,
    ...
    # ── Personnes ─────────────────────────────────────────────────────────────
    {
        "code": "P1", "dimension": "personnes", "order": 4,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "P2", "dimension": "personnes", "order": 5,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "P_c1", "dimension": "personnes", "order": 6,
        "is_conditional": True,
    ...
    # ── Processus ─────────────────────────────────────────────────────────────
    {
        "code": "PR1", "dimension": "processus", "order": 7,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "PR2", "dimension": "processus", "order": 8,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "PR_c1", "dimension": "processus", "order": 9,
        "is_conditional": True,
    ...
    # ── Technologies ──────────────────────────────────────────────────────────
    {
        "code": "T1", "dimension": "technologies", "order": 10,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "T2", "dimension": "technologies", "order": 11,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "T_c1", "dimension": "technologies", "order": 12,
        "is_conditional": True,
    ...
    # ── Gouvernance ───────────────────────────────────────────────────────────
    {
        "code": "G1", "dimension": "gouvernance", "order": 13,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "G2", "dimension": "gouvernance", "order": 14,
        "is_conditional": False, "condition": None,
    ...
    {
        "code": "G_c1", "dimension": "gouvernance", "order": 15,
        "is_conditional": True,

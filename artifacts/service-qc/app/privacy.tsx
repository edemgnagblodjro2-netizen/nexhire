...
export default function PrivacyScreen() {
  ...
  const sections = isFr
    ? [
        ...
        { title: "5. Partage avec des tiers", body: "Nous ne vendons jamais vos données. Aucune information n'est partagée avec des annonceurs, courtiers ou organismes publicitaires." },
    ...
    : [
        ...
        { title: "5. Sharing with third parties", body: "We never sell your data. No information is shared with advertisers, brokers, or marketing organizations." },

...
const HOTLINE_CATEGORIES: HotlineCategory[] = [
  ...
  },
  {
    ...
    icon: "user-check",
    color: "#9333ea",
    label: "Aînés en détresse · abus, isolement",
    labelEn: "Seniors in distress · abuse, isolation",
    hotlines: [
      {
        ...
        desc: "Écoute, information et référence pour aînés maltraités ou isolés",
        descEn: "Listening, info and referrals for mistreated or isolated seniors",
      },
      {
        name: "Tel-Aînés",
        nameEn: "Tel-Aînés",
        phone: "514-353-2463",
        hours: "10h à 22h, 7j/7 · Anonyme & gratuit",
        hoursEn: "10 AM–10 PM, 7 days · Anonymous & free",
        desc: "Écoute téléphonique pour aînés isolés ou en détresse",
        descEn: "Phone support for isolated or distressed seniors",
      },
    ],
  },
  {

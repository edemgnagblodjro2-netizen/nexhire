...
const QUICK_PROMPTS_FR = [
  ...
  "Je suis parent monoparental, j'ai besoin d'aide",
  "Je n'ai pas de carte santé",
  "Je suis aîné(e) et je vis seul(e)",
  "J'ai besoin d'un manteau d'hiver",
  "Je cherche de l'aide juridique gratuite",
  "Je dois quitter un foyer violent ce soir",
  "Mon enfant a besoin d'une place en garderie d'urgence",
  "Je suis sans-papiers, puis-je avoir des soins ?",
  "Comment demander l'aide sociale ?",
  "Je veux acheter ma première maison",
...
const QUICK_PROMPTS_EN = [
  ...
  "Help for my family",
  "I just lost my job",
  "I'm a single parent and need help",
  "I don't have a health card",
  "I'm a senior living alone",
  "I need a winter coat",
  "I'm looking for free legal aid",
  "I need to leave a violent home tonight",
  "My child needs emergency daycare",
  "I'm undocumented — can I get healthcare?",
...
const QUICK_PROMPTS_ES = [
  ...
  "Soy padre/madre soltero(a) y necesito ayuda",
  "No tengo tarjeta de salud",
  "Soy adulto mayor y vivo solo(a)",
  "Necesito un abrigo de invierno",
  "Busco asesoría legal gratuita",
  "Necesito salir de un hogar violento esta noche",
  "Mi hijo necesita guardería de emergencia",
  "Soy indocumentado(a) ¿puedo recibir atención médica?",
  "¿Cómo solicito asistencia social?",
  "Quiero comprar mi primera casa",
  "Quiero mudarme a Quebec",
  "Quiero una estimación de mi declaración de impuestos",
  "¿Qué ayudas económicas puedo recibir?",
  "Top 10 trámites al llegar a Quebec",
  "¿Cómo obtener mi tarjeta RAMQ?",
  "¿Cómo abrir una cuenta bancaria en Quebec?",
...
const QUICK_PROMPTS_AR = [
  ...
  "فقدت عملي مؤخراً",
  "أنا أب/أم وحيد(ة) وأحتاج مساعدة",
  "ليس لدي بطاقة صحية",
  "أنا مسن(ة) وأعيش وحيداً",
  "أحتاج معطفاً شتوياً",
  "أبحث عن مساعدة قانونية مجانية",
  "يجب أن أغادر منزلاً عنيفاً الليلة",
  "طفلي يحتاج حضانة طارئة",
  "أنا بدون أوراق، هل يمكنني الحصول على الرعاية الصحية؟",
  "كيف أتقدم للحصول على المساعدة الاجتماعية؟",
  "أريد شراء منزلي الأول",
  "أريد الانتقال إلى كيبيك",
  "أريد تقدير الإقرار الضريبي",
  "ما هي المساعدات المالية التي يمكنني الحصول عليها؟",
  "أهم 10 خطوات عند الوصول إلى كيبيك",
  "كيف أحصل على بطاقة RAMQ الصحية؟",
  "كيف أفتح حساباً بنكياً في كيبيك؟",
...
const QUICK_PROMPTS_HT = [
  ...
  "Mwen sot pèdi travay mwen",
  "Mwen se yon paran pou kont mwen, mwen bezwen èd",
  "Mwen pa gen kat sante",
  "Mwen se yon granmoun k ap viv pou kont mwen",
  "Mwen bezwen yon manto pou sezon fredi",
  "Mwen ap chèche èd legal gratis",
  "Mwen dwe kite yon kay vyolans aswè a",
  "Pitit mwen bezwen gadri ijans",
  "Mwen san papye, èske m ka jwenn swen sante?",
  "Kijan pou mwen mande èd sosyal?",
  "Mwen vle achte premye kay mwen",
  "Mwen vle demenaje nan Kebèk",
  "Mwen vle yon estimasyon deklarasyon enpo mwen",
  "Ki èd finansye mwen ka resevwa?",
  "Top 10 demach pou fè lè ou rive nan Kebèk",
  "Kijan pou mwen jwenn kat RAMQ mwen?",
  "Kijan pou mwen ouvri yon kont bankè nan Kebèk?",

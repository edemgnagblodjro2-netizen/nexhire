...
export const RESTAURANTS: Restaurant[] = [
  ...
  },
  {
    ...
    cuisine: "steakhouse",
    description:
      "Depuis 1938, Moishes incarne le steakhouse montréalais par excellence. Côtes levées, faux-filets et ambiance rétro pour une expérience hors du temps.",
    address: "3961 Boulevard Saint-Laurent, Montréal",
    phone: "514-845-3509",
    website: "https://moishes.ca",
    rating: 4.5,
    priceRange: "$$$$",
    coordinates: { lat: 45.5192, lng: -73.5847 },
    mustTry: "T-bone 24 oz vieilli à sec",
  ...
  },
  {
    ...
    description:
      "Restaurant de fruits de mer au Vieux-Montréal signé Chuck Hughes. Huîtres fraîches, homard, pétoncles et une vue imprenable sur la rue Saint-Paul.",
    address: "361 Rue Saint-Paul E, Montréal",
    phone: "514-544-0446",
    website: "https://lebremner.com",
    rating: 4.4,
    priceRange: "$$$",
    coordinates: { lat: 45.5076, lng: -73.5525 },
    mustTry: "Plateau de fruits de mer et huîtres Belon",
    openHours: "Mar-Sam 17h30–22h",
  },
  ...
  },
  {
    ...
    cuisine: "québécois",
    description:
      "Restaurant contemporain qui réinterprète la cuisine québécoise avec finesse. Produits régionaux, présentations soignées et atmosphère chaleureuse dans le Vieux-Québec.",
    address: "17 Rue Sault-au-Matelot, Québec",
    phone: "418-692-1334",
    website: "https://restauranttoast.com",
    rating: 4.6,
    priceRange: "$$$",
    coordinates: { lat: 46.8145, lng: -71.2058 },
    mustTry: "Ris de veau et fromages affinés locaux",
    openHours: "Mar-Sam 18h–21h30",
  },
  {
    id: "qc-04",
  ...
  {
    id: "lon-01",
    name: "La Maison William Gray",
    city: "Longueuil",
    region: "Vieux-Longueuil",
    cuisine: "français",
    description:
      "Restaurant gastronomique dans une maison historique du Vieux-Longueuil. Cuisine française raffinée dans un cadre patrimonial unique avec une belle terrasse jardin.",
    address: "1200 Chemin du Tremblay, Longueuil",
    phone: "450-679-4242",
    website: "https://maisonwilliamgray.com",
    rating: 4.4,
    priceRange: "$$$",
    coordinates: { lat: 45.5317, lng: -73.4989 },
    mustTry: "Magret de canard et croustade aux pommes",
    openHours: "Mar-Sam 17h30–21h30",
  },
];

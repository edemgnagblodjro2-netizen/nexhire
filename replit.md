...
## v1.1.13 vc76 (en attente OK build) — +Montérégie 1007 + Côte-Nord 535 via endpoint bulk déployé
...
- **PROD : 2750 → 4052 services actifs (+1302)** ce soir (Montérégie 1007 + Côte-Nord 535, dont 240 Mont déjà comptés via burst initial).
- Cache mobile bumpé v23→v25. Bundle régénéré (4052 fiches).
- **Méthode forte définitivement validée** : Côte-Nord 535 fiches en **1 requête de 3 sec**, vs ~7h estimées en burst+wait XFF. Format texte 211 (paste) géré aussi bien que PDF.

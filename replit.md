...
## v1.1.13 vc76 (en attente OK build) — +Montérégie 1007 + Côte-Nord 535 + Chaudière-Appalaches 995 via endpoint bulk
...
- **PROD : 2750 → 5047 services actifs (+2297)** ce soir (Montérégie 1007 + Côte-Nord 535 + Chaudière-Appalaches 995). Milestone +5000 services franchi 🎯.
- Cache mobile bumpé v23→v26. Bundle régénéré (5047 fiches).
- **Méthode forte définitivement validée** : 3 régions complètes (1542 + 995 = 2537 fiches) en environ ~10 sec de push cumulé. Format texte 211 (paste) géré aussi bien que PDF, qu'il y ait codes SLC/QBC/CQE/MAN mélangés.

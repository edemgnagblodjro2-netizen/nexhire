...
**v1.0.56 — 2026-05-02 (suite 13) — Expansion 7 provinces : QC + MB + ON + NB + NL + NS + BC (4 088 services)**

**Total base : 4 088 services** sur **7 provinces** (2 942 QC · 697 BC · 187 ON · 167 MB · 90 NB · 4 NL · 1 NS), tous géocodés. **QC franchit la barre des 2 900 fiches → 2 942** (+896 grâce au bloc sport/loisirs/culture, plus gros bloc à ce jour avec bloc 24 food). 12 catégories QC : **949 social** (devient catégorie #1 QC, devant food) · 766 food · 525 administrative · 204 immigration · 125 health · **106 family** · 74 mentalHealth · 65 employment · 60 housing · 55 legal · 10 childcare · 3 realestate. **48 fiches QC province-wide**. **262 villes QC géocodées** au total.
